class BookingModel {
  ...
  factory BookingModel.fromMap(Map<String, dynamic> map) {
    return BookingModel(
      ...
      bookingDate: DateTime.parse(map['bookingDate'] ?? map['booking_date']),
      ...
      carBrand: map['carBrand'] ?? map['car_brand'],
      carModel: map['carModel'] ?? map['car_model'],
      plateNumber: map['plateNumber'] ?? map['plate_number'],
