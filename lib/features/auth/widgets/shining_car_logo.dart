...
class _ShiningCarLogoState extends State<ShiningCarLogo> with SingleTickerProviderStateMixin {
...
class _CarPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final windowPaint = Paint()..color = Colors.white.withOpacity(0.2);
    ...
    if (progress > 0.4 && progress < 0.6) {
      final sparklePaint = Paint()
        ..color = Colors.white.withOpacity((1.0 - (progress - 0.5).abs() * 10).clamp(0, 1))
  ...
  @override
  bool shouldRepaint(covariant _CarPainter oldDelegate) => oldDelegate.progress != progress;
}
